...
contract("tea price feeds", function (accounts) {
  ...
  describe("price feeds", function () {
    it("2", async function () {
      let teaPriceFeedNFT = await TeaPriceFeedNFT.at(
        "0x12c602FbCc91Ac7Fa45Aa3883B64b0641463AAFe"
      );
      console.log("1. teaPriceFeedNFT", teaPriceFeedNFT.address);

      let teaPriceFeedNFTClient = await TeaPriceFeedNFTClient.at(
        "0x51eb4a5Fd87f44592a7757d9922edE2E962AFe32"
      );
      console.log("2. teaPriceFeedNFTClient", teaPriceFeedNFTClient.address);

      transaction = await teaPriceFeedNFTClient.randomnessRequest(
        "231234",
        "0x2f2a88c990a072061563923b0229c2514e5df82e806eceaabc961eb7203fde85"
      );
